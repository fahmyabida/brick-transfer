...
type ReversalBalanceWorker struct {
	UserBalanceUsecase domain.IUserBalanceUsecase
	Validator          validator.Validate
}

func NewReversalBalanceWorker(UserBalanceUsecase domain.IUserBalanceUsecase) ReversalBalanceWorker {
	return ReversalBalanceWorker{
		UserBalanceUsecase: UserBalanceUsecase,
		Validator:          *validator.New(),
	}
}

func (w ReversalBalanceWorker) validateMessage(ctx context.Context, m *sqs.Message) (payload domain.Transfers, err error) {
...
func (w ReversalBalanceWorker) GetHandler() func(ctx context.Context, m *sqs.Message) error {
	return func(ctx context.Context, m *sqs.Message) (err error) {
		...
		err = w.UserBalanceUsecase.ReversalBalance(ctx, &payload)
		if err != nil {
